...
class BinaryOpExpr final : public Expr {
 ...
 public:
  explicit BinaryOpExpr(Type type,
...
class CellExpr final : public Expr {
 public:
  ...
  // Если пустая ячейка или строка возвращает 0, если формула, возвращает ошибку
  // или число
  double Evaluate(const SheetInterface& sheet) const override {
    //try {
...
class NumberExpr final : public Expr {
 public:
  ...
  double Evaluate(const SheetInterface& sheet) const override { return value_; }
