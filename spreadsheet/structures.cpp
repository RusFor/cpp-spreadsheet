...
// Находится ли на границе таблицы
// bool Size::operator==(Position rhs) const {
//     return cols == rhs.col || rows == rhs.row;
// }
// bool Size::operator>(Position rhs) const
//{
//     return cols > rhs.col && rows > rhs.row;
...
//     return cols < rhs.col || rows < rhs.row;
// }
////находится ли внутри или на границе таблицы
// bool Size::operator<=(Position rhs) const {
//     return *this < rhs || *this == rhs;
// }

void ClearVector(CellsOrder& v) {
